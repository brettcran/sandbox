/* TurboSign 4.0 — stable ESM PWA build
   - PDF.js v5 ESM core & local module worker (no CDN dependency)
   - pdf-lib imported locally (lib/vendor/pdf-lib.esm.js)
   - Same UI/behaviors as your 4.0 base
*/
...
try {
  ...
  // Last‑resort (still ESM & offline): main thread rendering
...
class Annotations{
  ...
  _onUp(e){
    ...
    if(changed) {/* mark dirty if you wire snapshots later */}
  }
